...
export class ObservacionesAlojamientoDto {
	...
	@ApiPropertyOptional({
		description:
			'Texto de la observación de características de la vivienda',
		example: 'La vivienda cuenta con una cocina equipada.',
	})
	@IsString()
	@IsOptional()
	readonly texto_observacion_caracteristicas_de_la_vivienda: string;
}
